...
void init_growatt124(sProtocolDefinition_t &Protocol) {
  ...
  // FEAGMENT 4: BEGIN
   Protocol.InputRegisters[P124_SOC_NEW] = sGrowattModbusReg_t{
      3171, 0, SIZE_16BIT, "SOC_NEW", 1, 1, PRECENTAGE, true, false};
  // FEAGMENT 4: END
