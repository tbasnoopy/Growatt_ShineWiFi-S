...
void init_growatt120(sProtocolDefinition_t &Protocol) {
  ...
  Protocol.InputRegisters[P120_I_STATUS] = sGrowattModbusReg_t{
      0,    0,    SIZE_16BIT, "InverterStatus",      1, 1,
      NONE, true, false,      ByteOrder_t::FirstHigh};  // 0:waiting, 1:normal,
                                                        // 3:fault
  // 1. Ppv H Input power (high) 0.1W
  Protocol.InputRegisters[P120_INPUT_POWER] = sGrowattModbusReg_t{
      1,   0,       SIZE_32BIT, "InputPower", 0.1,
      0.1, POWER_W, true,       true,         ByteOrder_t::FirstHigh};
  ...
  Protocol.InputRegisters[P120_PV1_VOLTAGE] = sGrowattModbusReg_t{
      ...
      0.1, VOLTAGE, false,      false,        ByteOrder_t::FirstHigh};
  ...
  Protocol.InputRegisters[P120_PV1_INPUT_CURRENT] = sGrowattModbusReg_t{
      ...
      CURRENT, false, false,      ByteOrder_t::FirstHigh};
  // 5. Ppv1 H PV1 input power(high) 0.1W
  Protocol.InputRegisters[P120_PV1_INPUT_POWER] = sGrowattModbusReg_t{
      5,       0,    SIZE_32BIT, "PV1InputPower",       0.1, 0.1,
      POWER_W, true, true,       ByteOrder_t::FirstHigh};
  ...
  Protocol.InputRegisters[P120_GRID_FREQUENCY] = sGrowattModbusReg_t{
      37,   0,         SIZE_16BIT, "GridFrequency", 0.01,
      0.01, FREQUENCY, false,      false,           ByteOrder_t::FirstHigh};
  // 38. Vac1 Three/single phase grid voltage 0.1V
  Protocol.InputRegisters[P120_GRID_L1_VOLTAGE] = sGrowattModbusReg_t{
      38,  0,       SIZE_16BIT, "GridL1Voltage", 0.1,
      0.1, VOLTAGE, false,      false,           ByteOrder_t::FirstHigh};
  ...
  Protocol.InputRegisters[P120_GRID_L1_OUTPUT_POWER] = sGrowattModbusReg_t{
      40, 0,     SIZE_32BIT, "GridL1OutputPower",   0.1, 0.1,
      VA, false, false,      ByteOrder_t::FirstHigh};
  ...
  Protocol.InputRegisters[P120_GRID_L2_VOLTAGE] = sGrowattModbusReg_t{
      42,  0,       SIZE_16BIT, "GridL2Voltage", 0.1,
      0.1, VOLTAGE, false,      false,           ByteOrder_t::FirstHigh};
  ...
  Protocol.InputRegisters[P120_GRID_L2_OUTPUT_POWER] = sGrowattModbusReg_t{
      44, 0,     SIZE_32BIT, "GridL2OutputPower",   0.1, 0.1,
      VA, false, false,      ByteOrder_t::FirstHigh};
  ...
  Protocol.InputRegisters[P120_GRID_L3_VOLTAGE] = sGrowattModbusReg_t{
      46,  0,       SIZE_16BIT, "GridL3Voltage", 0.1,
      0.1, VOLTAGE, false,      false,           ByteOrder_t::FirstHigh};
  ...
  Protocol.InputRegisters[P120_GRID_L3_OUTPUT_POWER] = sGrowattModbusReg_t{
      48, 0,     SIZE_32BIT, "GridL3OutputPower",   0.1, 0.1,
      VA, false, false,      ByteOrder_t::FirstHigh};
  // FRAGMENT 1: END
  ...
  Protocol.InputRegisters[P120_ENERGY_TOTAL] = sGrowattModbusReg_t{
      55,  0,         SIZE_32BIT, "EnergyTotal", 0.1,
      0.1, POWER_KWH, true,       false,         ByteOrder_t::FirstHigh};
  ...
  Protocol.InputRegisters[P120_WORK_TIME_TOTAL] = sGrowattModbusReg_t{
      57, 0,       SIZE_32BIT, "WorkTimeTotal", 0.5,
      1,  SECONDS, false,      false,           ByteOrder_t::FirstHigh};
  ...
  Protocol.InputRegisters[P120_PV1_ENERGY_TODAY] = sGrowattModbusReg_t{
      ...
      POWER_KWH, false, false,      ByteOrder_t::FirstHigh};
  ...
  Protocol.InputRegisters[P120_PV3_ENERGY_TODAY] = sGrowattModbusReg_t{
      67,        0,     SIZE_32BIT, "PV3EnergyToday",      0.1, 0.1,
      POWER_KWH, false, false,      ByteOrder_t::FirstHigh};
  ...
  Protocol.InputRegisters[P120_PV3_ENERGY_TOTAL] = sGrowattModbusReg_t{
      69,        0,     SIZE_32BIT, "PV3EnergyTotal",      0.1, 0.1,
      POWER_KWH, false, false,      ByteOrder_t::FirstHigh};
  ...
  Protocol.InputRegisters[P120_PV4_ENERGY_TODAY] = sGrowattModbusReg_t{
      71,        0,     SIZE_32BIT, "PV4EnergyToday",      0.1, 0.1,
      POWER_KWH, false, false,      ByteOrder_t::FirstHigh};
  ...
  Protocol.InputRegisters[P120_PV4_ENERGY_TOTAL] = sGrowattModbusReg_t{
      73,        0,     SIZE_32BIT, "PV4EnergyTotal",      0.1, 0.1,
      POWER_KWH, false, false,      ByteOrder_t::FirstHigh};
  ...
  Protocol.InputRegisters[P120_PV5_ENERGY_TODAY] = sGrowattModbusReg_t{
      75,        0,     SIZE_32BIT, "PV5EnergyToday",      0.1, 0.1,
      POWER_KWH, false, false,      ByteOrder_t::FirstHigh};
  ...
  Protocol.InputRegisters[P120_PV5_ENERGY_TOTAL] = sGrowattModbusReg_t{
      77,        0,     SIZE_32BIT, "PV5EnergyTotal",      0.1, 0.1,
      POWER_KWH, false, false,      ByteOrder_t::FirstHigh};
  ...
  Protocol.InputRegisters[P120_PV6_ENERGY_TODAY] = sGrowattModbusReg_t{
      79,        0,     SIZE_32BIT, "PV6EnergyToday",      0.1, 0.1,
      POWER_KWH, false, false,      ByteOrder_t::FirstHigh};
  ...
  Protocol.InputRegisters[P120_PV6_ENERGY_TOTAL] = sGrowattModbusReg_t{
      81,        0,     SIZE_32BIT, "PV6EnergyTotal",      0.1, 0.1,
      POWER_KWH, false, false,      ByteOrder_t::FirstHigh};
  ...
  Protocol.InputRegisters[P120_PV7_ENERGY_TODAY] = sGrowattModbusReg_t{
      83,        0,     SIZE_32BIT, "PV7EnergyToday",      0.1, 0.1,
      POWER_KWH, false, false,      ByteOrder_t::FirstHigh};
  ...
  Protocol.InputRegisters[P120_PV7_ENERGY_TOTAL] = sGrowattModbusReg_t{
      85,        0,     SIZE_32BIT, "PV7EnergyTotal",      0.1, 0.1,
      POWER_KWH, false, false,      ByteOrder_t::FirstHigh};
  ...
  Protocol.InputRegisters[P120_PV8_ENERGY_TODAY] = sGrowattModbusReg_t{
      87,        0,     SIZE_32BIT, "PV8EnergyToday",      0.1, 0.1,
      POWER_KWH, false, false,      ByteOrder_t::FirstHigh};
  ...
  Protocol.InputRegisters[P120_PV8_ENERGY_TOTAL] = sGrowattModbusReg_t{
      89,        0,     SIZE_32BIT, "PV8EnergyTotal",      0.1, 0.1,
      POWER_KWH, false, false,      ByteOrder_t::FirstHigh};
  ...
  Protocol.InputRegisters[P120_PV_ENERGY_TOTAL] = sGrowattModbusReg_t{
      91,  0,         SIZE_32BIT, "PVEnergyTotal", 0.1,
      0.1, POWER_KWH, true,       false,           ByteOrder_t::FirstHigh};
  ...
  Protocol.InputRegisters[P120_INVERTER_TEMPERATURE] = sGrowattModbusReg_t{
      ...
      TEMPERATURE, true, true,       ByteOrder_t::FirstHigh};
  ...
  Protocol.InputRegisters[P120_REAL_OUTPUT_POWER] = sGrowattModbusReg_t{
      ...
      PRECENTAGE, false, false,      ByteOrder_t::FirstHigh};
  // 102. OPFullwatt H Output Maxpower Limited high
  Protocol.InputRegisters[P120_OUTPUT_MAXPOWER_LIMITED] = sGrowattModbusReg_t{
      102,     0,     SIZE_16BIT, "LimitedOutputPower",  1, 1,
      POWER_W, false, false,      ByteOrder_t::FirstHigh};
  ...
  Protocol.InputRegisters[P120_DERATINGMODE] =
      sGrowattModbusReg_t{104,  0,     SIZE_16BIT, "DeratingMode",        1, 1,
                          NONE, false, false,      ByteOrder_t::FirstHigh};
  // 105. Fault code Inverter fault code &*1
  Protocol.InputRegisters[P120_FAULT_CODE] = sGrowattModbusReg_t{
      105,  0,    SIZE_16BIT, "FaultCode",           1, 1,
      NONE, true, false,      ByteOrder_t::FirstHigh};  // 0:no derate; 1:PV;
                                                        // 2:*; 3:Vac; 4:Fac;
                                                        // 5:Tboost; 6:Tinv;
                                                        // 7:Control; 8:*;
                                                        // 9:*OverBack ByTime;
  ...
  // ByteOrder_t::FirstHigh}; 114. inv start delay time inv start delay time
  // Protocol.InputRegisters[P120_START_DELAY] = sGrowattModbusReg_t{57, 0,
  // SIZE_32BIT, "StartDelay", 0.5, SECONDS, false, false,
  // ByteOrder_t::FirstHigh}; 115. bINVAllFaultCod e bINVAllFaultCode FRAGMENT
  // 3: END
  ...
  Protocol.HoldingRegisters[P120_OnOff] =
      sGrowattModbusReg_t{0, 0,    SIZE_16BIT, "OnOff", 1,
                          1, NONE, true,       false,   ByteOrder_t::FirstHigh};
  Protocol.HoldingRegisters[P120_CMD_MEMORY_STATE] =
      sGrowattModbusReg_t{2,    0,    SIZE_16BIT, "CmdMemoryState",      1, 1,
                          NONE, true, false,      ByteOrder_t::FirstHigh};
  Protocol.HoldingRegisters[P120_Active_P_Rate] = sGrowattModbusReg_t{
      3,          0,    SIZE_16BIT, "ActivePowerRate",     1, 1,
      PRECENTAGE, true, false,      ByteOrder_t::FirstHigh};
  // FRAGMENT 1: END
}
